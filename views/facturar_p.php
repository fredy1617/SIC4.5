...
<div class="container">
  <div class="row">
      <br><br>
      <h3 class="hide-on-med-and-down col s12 m9 l9">Facturar</h3>
      <h5 class="hide-on-large-only col s12 m9 l9">Facturar</h5>   
    </div>
  <div class="row">
      <p><div id="resultado_reporte_pendiente">
        <table class="bordered  highlight responsive-table">
          ...
          <tbody>
          <?php
          $sql_orden = mysqli_query($conn,"SELECT * FROM orden_servicios  WHERE  estatus = 'Facturar' ORDER BY fecha");
