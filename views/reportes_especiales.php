...
<script>
  ...
  $.post("../views/buscar_reportes_esp.php", {
          texto: texto,
        }, function(mensaje) {
...
<div class="container">
  <div class="row">
      <br><br>
      <h3 class="hide-on-med-and-down col s12 m6 l6">Reportes Especiales Pendientes</h3>
      <h5 class="hide-on-large-only col s12 m6 l6">Reportes  Especiales Pendientes</h5>
