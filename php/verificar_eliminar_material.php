...
<div id="modalverificar" class="modal modal-fixed-footer row col s10 container">
    <div class="modal-content"><br><br><br>
      <h4 id="resultado_ruta" class="red-text">¿Seguro de eliminar el material no. serie: <?php echo $Serie; ?>?</h4><br><br>
      ...
      <div class="input-field col s12 m8 l8">
          ...
          <input id="serie" name="serie" type="hidden" value="<?php echo $Serie ?>">
      </div>
      </form>
    </div>
