	...
	function folioCliente(){
        ...
        if ((mysqli_num_rows(mysqli_query($conn, "SELECT * FROM clientes WHERE id_cliente = $id_cliente"))) == 0) {
		 ...
		 // Colores de los bordes, fondo y texto
            ...
            if (($id_user == 47 OR $id_user == 42 OR $id_user == 31 OR $id_user == 52 OR $id_user == 67 OR $id_user == 57 OR $id_user == 63 OR $id_user == 24 OR $id_user == 55 OR $id_user == 29) AND $tipo_pago != 'Otros Pagos') {
                $this->Ln(5);
