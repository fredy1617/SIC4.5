	...
	if(mysqli_num_rows(mysqli_query($conn, $sql_ip))>0){
		...
		//////// configura tus datos		
		        	...
		        	if(mysqli_query($conn,$sql)){
						...
						if ($Liquidar != 0) {	
							$sql = "INSERT INTO pagos (id_cliente, descripcion, cantidad, fecha, hora, tipo, id_user, corte, tipo_cambio) VALUES ('$IdCliente', '$Descripcion', '$Liquidar', '$FechaInstalacion', '$Tipo_t', '$id_user', 0, '$Tipo_Campio')";
