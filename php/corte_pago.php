<?php
    ...
    class PDF extends FPDF{
        function folioCliente()
        {
            ...
            $Cort =  mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM cortes WHERE id_corte = $corte"));  
            ...
            $sql_efectivoI = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio' AND tipo != 'Orden Servicio'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $total_EI=  mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio'"));
                $this->MultiCell(65,4,utf8_decode('SUBTOTAL: $'.$total_EI['precio'].'.00'),0,'R',true);
                $this->Ln(10);
            }
            //---------------BANCO-------------------------------------------
            
            $sql_bancoI = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $totalbancoI = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio'"));
                $this->MultiCell(65,4,utf8_decode('SUBTOTAL: $'.$totalbancoI['precio'].'.00'),0,'R',true);
                $this->Ln(10);
            }
            //---------------CREDITO-------------------------------------------

            $sql_creditoI = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Credito' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $total_CI=  mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Credito' AND tipo != 'Dispositivo' AND tipo != 'Orden Servicio'"));
            ...
            $this->Ln(6);
            $sql_efectivoO = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo = 'Orden Servicio'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $total_EO=  mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo = 'Orden Servicio'"));
                $this->MultiCell(65,4,utf8_decode('SUBTOTAL: $'.$total_EO['precio'].'.00'),0,'R',true);
                $this->Ln(10);
            }
            //---------------BANCO-------------------------------------------
            
            $sql_bancoO = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo = 'Orden Servicio'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $totalbancoO = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo = 'Orden Servicio'"));
            ...
            $sql_efectivoST = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo = 'Dispositivo'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $total_EST=  mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Efectivo' AND tipo = 'Dispositivo'"));            
                $this->MultiCell(65,4,utf8_decode('SUBTOTAL: $'.$total_EST['precio'].'.00'),0,'R',true);
                $this->Ln(10);
            }
            //---------------BANCO-------------------------------------------
            
            $sql_bancoST = mysqli_query($conn, "SELECT * FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo = 'Dispositivo'");
            ...
            if ($filas > 0) {
                ...
                $this->SetFont('Arial','B',13);
                $this->Ln(8);
                $totalbancoST = mysqli_fetch_array(mysqli_query($conn, "SELECT SUM(cantidad) AS precio FROM pagos WHERE id_user=$id_user AND corte = 0 AND tipo_cambio='Banco' AND tipo = 'Dispositivo'"));            
                $this->MultiCell(65,4,utf8_decode('SUBTOTAL: $'.$totalbancoST['precio'].'.00'),0,'R',true);
                $this->Ln(10);
            }

            $Todos_Pagos = mysqli_fetch_array(mysqli_query($conn,"SELECT count(*) FROM pagos WHERE id_user=$id_user AND corte = 0" ));
            $this->Cell(60,4,'------------------------------------------',0,0,'C',true);
            $this->Ln(8);
            ...
            $this->SetFont('Arial','',11);
            $Telefono = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo IN ('Mes-Tel', 'Min-Extra')" ));
            if ($Telefono > 0) {
              $this->Cell(60,4,utf8_decode('Telefono = '.$Telefono),0,0,'C',true);
              $this->Ln(5);
            }
            $Mes_Internet = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Mensualidad'" ));
            if ($Mes_Internet > 0) {
              $this->Cell(60,4,utf8_decode('Mes-Internet = '.$Mes_Internet),0,0,'C',true);
              $this->Ln(5);
            }
            $Abonos = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Abono'" ));
            if ($Abonos > 0) {
              $this->Cell(60,4,utf8_decode('Abonos = '.$Abonos),0,0,'C',true);
              $this->Ln(5);
            }
            $AntInst = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Anticipo'" ));
            if ($AntInst > 0) {
              $this->Cell(60,4,utf8_decode('Anticipo Inst. = '.$AntInst),0,0,'C',true);
              $this->Ln(5);
            }
            $AbonoInst = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Abono Instalacion'" ));
            if ($AbonoInst > 0) {
              $this->Cell(60,4,utf8_decode('Abono Inst. = '.$AbonoInst),0,0,'C',true);
              $this->Ln(5);
            }
            $LiquidInst = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Liquidacion'" ));
            if ($LiquidInst > 0) {
              $this->Cell(60,4,utf8_decode('Liquidacion Inst. = '.$LiquidInst),0,0,'C',true);
              $this->Ln(5);
            }
            $Reporte = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Reporte'" ));
            if ($Reporte > 0) {
              $this->Cell(60,4,utf8_decode('Reportes = '.$Reporte),0,0,'C',true);
              $this->Ln(5);
            }
            $AntiDisp = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Dispositivo' AND descripcion = 'Anticipo'" ));
            if ($AntiDisp > 0) {
              $this->Cell(60,4,utf8_decode('Anticipo Disp. = '.$AntiDisp),0,0,'C',true);
              $this->Ln(5);
            }
            $LiquidDisp = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Dispositivo' AND descripcion = 'Liquidacion'" ));
            if ($LiquidDisp > 0) {
              $this->Cell(60,4,utf8_decode('Liquidacion Disp. = '.$LiquidDisp),0,0,'C',true);
              $this->Ln(5);
            }
            $Orden = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Orden Servicio'" ));
            if ($Orden > 0) {
              $this->Cell(60,4,utf8_decode('Ordenes Serv. = '.$Orden),0,0,'C',true);
              $this->Ln(5);
            }
            $Otros = mysqli_num_rows(mysqli_query($conn,"SELECT *  FROM pagos WHERE corte = 0 AND id_user = $id_user AND tipo = 'Otros Pagos'" ));
            if ($Otros > 0) {
            ...
            $this->Ln(15);          
            mysqli_query($conn,"UPDATE pagos SET corte=1 WHERE id_user=$id_user");
            mysqli_close($conn);
        }
    }
